...
class MyGame(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        deadly_hit_list = arcade.check_for_collision_with_list(self.player_sprite,
                                                               self.deadly_list)
        ...
        door_hit_list = arcade.check_for_collision_with_list(self.player_sprite,
                                                             self.door_list)
        if door_hit_list and self.interact_pressed:
        ...
        for i in range(len(self.lives_list)):
            self.lives_list[i].center_y = self.view_bottom + (SCREEN_HEIGHT * 14 / 15)
